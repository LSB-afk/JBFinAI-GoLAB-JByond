...
const JPO_SIGNAL_TYPES = {
  ...
  ABOVE_NEIGHBORHOOD_MEDIAN: "주변 전세 중앙값 대비 과다",
...
const jpoNavigation = [
  ...
  { section: "전세 위험 점검", items: [
    ...
    { id: "rent-comparables", icon: "refresh-cw", label: "유사 전월세 거래", description: "중앙값 비교", countKey: "rentComparables" },
