...
## 실행 (D-1, 7/2+7/3 회의 확정 기반)
- [ ] **[[본선-실행-백로그]]** — 개발(이승보)·디자인/시연(김민주)·문서/데이터(김주용)·제출물(7/5 10:30)·리스크. **먼저: D2 도메인 택1(7/4 오전)**

## 발표·시연
- [x] 발표 덱 아웃라인 초안 / 시연 시나리오 초안
- [x] **공식 안내문 정본화**([[본선_안내문]]) + 발표 전략 시나리오([[발표-5분-시나리오-전략]]) — 예선 5분/결선 15분 런시트
- [ ] 본선용 확정·리허설 (예선 5분 컷 + 결선 15분 컷 각각)
- [ ] 발표자료 PDF(필수 9항목) + **기능명세서 PDF(변경이력 필수)** + GitHub README + (가점)시연영상 5분
