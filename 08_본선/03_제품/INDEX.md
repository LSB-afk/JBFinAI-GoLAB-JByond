...
- [[08_본선/03_제품/설계도/_설계도-INDEX|설계도 인덱스]] — 5종(메인 업무보드·케이스상세·에이전트 실행뷰·승인·통계추적). "설계도만 봐도 와이어프레임 제작 가능" 수준(ASCII 와이어+컴포넌트 트리+데이터 바인딩+키맵)
- [[08_본선/03_제품/구현현황-JB_project2|JB_project2 구현현황]] — 코드 SSOT 실측(6진입·98뷰·40에이전트·121토큰·537컴포넌트, 실재/모의/부재)
- [[08_본선/03_제품/설계도/_화면목록-뷰맵|화면목록·뷰맵]] — 계열사×역할 양축 전체(98뷰 파리티): 66 제네릭 커버·29 특화 명세 필요·데모 8뷰
