...
| 기업여신 심사지원 포털 (역할 콘솔) | 역할 레일 → 기업여신 담당자 또는 `#/roles/corporate-credit/board` | 재무 요약·상환 체크·서류 확인·품의 초안 — 승인/거절·금리/한도는 항상 담당자 |
| FDS·보이스피싱 대응 포털 (역할 콘솔) | 역할 레일 → 보이스피싱/FDS 담당자 또는 `#/roles/fds-response/board` | 신호 요약·고객 확인 스크립트(승인 대기)·차단/보류 권고 — 종결은 항상 사람 |
