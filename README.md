...
이 MVP는 전북은행, 광주은행, JB우리캐피탈을 중심으로 지역 소상공인과 중소사업자의 연체 조짐, 금리 부담, 정책금융 매칭, 보이스피싱 위험을 하나의 `Case`로 묶고, 각 Agent가 스킬을 장착해 판단, 행동, 검증을 수행하는 운영 콘솔입니다. UI의 메인 모델명은 `JB LocalGuard OS`이며, 대회명은 보조 맥락으로만 사용합니다
