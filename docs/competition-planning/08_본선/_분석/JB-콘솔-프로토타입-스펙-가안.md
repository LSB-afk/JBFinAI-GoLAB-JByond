...
| **P1** | 시드 데이터 5모듈(`ui/src/data/`): jb-types·cases(**9건·계열사별 3건**, 히어로 JBG-104 8단계 타임라인 → 로스터 정본 [[JB-콘솔-페르소나-로스터]])·evidence·skills(md body)·plugins(MCP) | `2324d28` · 로스터확장 `9c79406` |
