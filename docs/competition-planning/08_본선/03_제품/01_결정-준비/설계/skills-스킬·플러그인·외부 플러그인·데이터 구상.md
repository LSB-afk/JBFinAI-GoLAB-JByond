...
> 이 문서의 목적 = 에이전트가 장착하는 스킬·MCP·외부 데이터를 계열사×직군×도메인 배치와 PII 방어 원칙에 맞춰 설계한다.
...
> 검증 2026-07-03 · 대조 SSOT: `_canon.md`, `02_제품/app/app.js`(`skillRack`·`approvalLevelMatrix`·`agents` 배열, 실제 구현), `08_본선/03_제품/01_결정-준비/근거팩/적법성-근거팩.md`, `D5a-결과.md`.
