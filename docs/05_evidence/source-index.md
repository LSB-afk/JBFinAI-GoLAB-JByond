...
- Local PDF: `[데이콘] JB금융그룹 Fin AI Challenge 상세주제 안내.pdf`
- DAKER public page: https://daker.ai/public/hackathons/jb-fin-ai-challenge
- DAKER structured endpoint: https://daker.ai/api/hackathons/jb-fin-ai-challenge
